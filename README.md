...
IMPORTANT: At the end of this README you will find the list of Python packages that you must have installed locally in order to run this repository. Please verify that each of these are installed before you attempt to run the scripts. You do not need to know Python to run the script, however you do need to have Python installed locally that is accessible through your IDE, and you do need to install the Python packages that are listed at the end of this document. 
